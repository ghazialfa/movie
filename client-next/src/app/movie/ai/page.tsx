  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32">
      <div className="container px-4 md:px-6 space-y-6">
        <h2 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl">AI Recommendations</h2>
        <div className="flex gap-2">
          ...
          />
          <Button onClick={() => mutate()} disabled={!prompt || isPending}>Kirim</Button>
        </div>
